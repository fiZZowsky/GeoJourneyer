...
public class DatabaseContext
{
    ...
    private void EnsureDatabase()
    {
        ...
        var commands = new[]
        {
            ...
            "CREATE TABLE IF NOT EXISTS Users (Id INTEGER PRIMARY KEY AUTOINCREMENT, Username TEXT NOT NULL, Email TEXT NOT NULL UNIQUE, PasswordHash TEXT NOT NULL, FirstName TEXT, LastName TEXT, Age INTEGER, CountryOfOrigin TEXT, PhotoUrl TEXT)"
        };
