...
public class DatabaseContext
{
    ...
    private void EnsureDatabase()
    {
        ...
        var commands = new[]
        {
            ...
            "CREATE TABLE IF NOT EXISTS Notifications (Id INTEGER PRIMARY KEY AUTOINCREMENT, UserId INTEGER NOT NULL, Type INTEGER NOT NULL, Text TEXT NOT NULL, IsRead INTEGER)"
        };
