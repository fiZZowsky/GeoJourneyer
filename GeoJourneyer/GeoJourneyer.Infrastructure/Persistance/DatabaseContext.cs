...
public class DatabaseContext
{
    ...
    private void EnsureDatabase()
    {
        ...
        var commands = new[]
        {
            ...
            "CREATE TABLE IF NOT EXISTS TravelPlans (Id INTEGER PRIMARY KEY AUTOINCREMENT, UserId INTEGER NOT NULL, CountryId INTEGER NOT NULL, Name TEXT, CreatedAt TEXT NOT NULL)",
            ...
            "CREATE TABLE IF NOT EXISTS Notifications (Id INTEGER PRIMARY KEY AUTOINCREMENT, FromUserId INTEGER, UserId INTEGER NOT NULL, Type INTEGER NOT NULL, Text TEXT NOT NULL, IsRead INTEGER)"
        };
